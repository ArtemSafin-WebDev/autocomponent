...
import styles from "./StorageParametersDetail.module.scss"
      ...
      <div className={styles.parameters__container}>
        <ul className={styles.parameters__filters}>
          <li className={styles.parameters__filter}>
            <DropDown
              dropDownValues={["Ширина шины, мм", "Ширина шин, мм", "Ширина ши, мм"]}
              activeIndexValue={1}
              buttonStyle={buttonStyle}
              dropDownStyle={dropDownStyle}
            />
            <DropDown
              dropDownValues={["Профиль, %", "10%", "20%"]}
              activeIndexValue={1}
              buttonStyle={buttonStyle}
              dropDownStyle={dropDownStyle}
            />
            <DropDown
              dropDownValues={["R 13", "R 15", "12", "13", "14", "R 15"]}
              activeIndexValue={1}
              buttonStyle={buttonStyle}
              dropDownStyle={dropDownStyle}
            />
